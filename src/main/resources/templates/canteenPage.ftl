...
<html>
    ...
    <body>
        <header class="main-header">
            ...
            <h1 class="band-name band-name-large"> <a href="index.ftl" style="text-decoration: none; color: rgb(255, 255, 255);font-family: 'Baloo Chettan', cursive; ";>ВЫБРАТЬ СТОЛОВУЮ</a></h1>
        </header>
